...
table = {"classified as e":[],"classified as c":[],"classified as n":[]}
...
class_as_n = []
for i,gold in enumerate(['e','c','n']):
    sub_df1 = eval_df[eval_df['label'] == gold]
    sub_df1 = sub_df1[sub_df1['e_pred'] == False]
    sub_df1 = sub_df1[sub_df1['c_pred'] == False]
    sub_df2 = eval_df[eval_df['label'] == gold]
    sub_df2 = sub_df2[sub_df2['e_pred'] == True]
    sub_df2 = sub_df2[sub_df2['c_pred'] == True]
    class_as_n.append(len(sub_df1)+len(sub_df2))
...
# table['classified as n'] = class_as_both
